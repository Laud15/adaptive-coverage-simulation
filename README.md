...
configuration. A `change_priority_range` routine event assigns new quotas to
all active points. Random positions and quotas generated by a routine use the
independent `event_seed`.
...
| `max_priority` | Upper bound of the initial integer quota range; also used for routine-generated births until a priority-range event changes it |
